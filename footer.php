...
<footer>
   <div class="frow">
      <div class="fcol">
         ...
         <p>Best Coffe Shop with affrodable price.</p>
      </div>
      <div class="fcol">
         ...
         <p class="email-id" style="text-transform: lowercase;">hamad.ismail.gub@gmail.com</p>
         <h4>+880 1816 401 515</h4>
      </div>
      <div class="fcol">
   ...
   <hr class="hh">
   <p class="copyright">Hamad Ismail © 2021 - All Rights Reserved</p>
</footer>